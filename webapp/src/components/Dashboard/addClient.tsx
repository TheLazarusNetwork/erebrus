...
const AddClient = () => {
  ...
  return (
    <div>
      <label htmlFor="add-client-modal">Add Client</label>
            ...
            <form onSubmit={handleAddClient}>
              <div className="space-y-4">
                <div>
                  <label
                    htmlFor="name"
                    className="block text-blue-100 text-md text-left my-3 font-semibold"
                  >
                    Name
                  </label>
                  <input
                ...
                <div className="form-control">
                  <label className="label cursor-pointer">
                    <span className="label-text text-gray-100 text-md">
                      Enable/Disable User
                    </span>
                    <input
                      id="enable"
              ...
              <button
                type="submit"
                className="bg-gradient-to-r from-blue-300 to-blue-500 text-gray-900 font-semibold rounded-lg p-3 px-5 mt-4"
              >
                Submit
              </button>
            </form>
